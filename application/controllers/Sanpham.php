...
class Sanpham extends CI_Controller {
    ...
    public function index(){
        ...
        $total=$this->Mproduct->product_sanpham_count(null);
        $this->data['strphantrang']=$this->phantrang->PagePer($total, $current, $limit, $url='san-pham', null);
        $this->data['list']=$this->Mproduct->product_sanpham($limit,$first,$f,$od);
        $this->data['title']='Kim Cương - Tất cả sản phẩm';
    ...
    public function category(){
        ...
        $this->data['strphantrang']=$this->phantrang->PagePer($total, $current, $limit, $url='san-pham/'.$link, null);
        $this->data['list']=$this->Mproduct->product_list_cat_limit($listcat, $limit,$first,$f,$od);
        $this->data['title']='Kim Cương - Sản phẩm theo từng danh mục';  
    ...
    public function detail($link){   
        ...
        $this->data['row']=$row;
        $this->data['title']='Kim Cương - '.$row['name'];  
    ...
    public function update(){
        ...
        $this->form_validation->set_rules('sl', 'Số lượng', 'max_length['.$max.']');
    ...
    function _check_length($id, $value)
    {
        $length = strlen($value);
        $max = $this->Mproduct->product_detail_id($id);
