...
class Coupon extends CI_Controller {
	...
	public function index()
	{
		...
		$total=$this->Mcoupon->coupon_count($keyword);
		$this->data['strphantrang']=$this->phantrang->PagePer($total, $current, $limit, $url='admin/coupon',$keyword);
		$this->data['list']=$this->Mcoupon->coupon_all($limit,$first,$keyword);
	...
	public function recyclebin()
	{
		...
		$this->data['strphantrang']=$this->phantrang->PagePer($total, $current, $limit, $url='admin/coupon/recyclebin', null);
