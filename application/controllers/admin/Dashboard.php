...
class Dashboard extends CI_Controller {
	...
	{
		$this->data['total1']=$this->Mproduct->product_sanpham_count(null);
		$this->data['total2']=$this->Mcontent->content_count(null);
		$this->data['total3']=$this->Mcustomer->customer_count(null);
		$this->data['total4']=$this->Morders->orders_count(null);
