...
class Category extends CI_Controller {
	...
	public function index()
	{
		...
		$total=$this->Mcategory->category_count($keyword);
		$this->data['strphantrang']=$this->phantrang->PagePer($total, $current, $limit, $url='admin/category', $keyword);
		$this->data['list']=$this->Mcategory->category_all($limit,$first,$keyword);
	...
	public function recyclebin()
	{
		...
		$this->data['strphantrang']=$this->phantrang->PagePer($total, $current, $limit, $url='admin/category/recyclebin', null);
