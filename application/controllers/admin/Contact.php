...
class Contact extends CI_Controller {
	...
	public function index(){
		...
		$total=$this->Mcontact->contact_count(null);
		$this->data['strphantrang']=$this->phantrang->PagePer($total, $current, $limit, $url='admin/contact', null);
		$this->data['list']=$this->Mcontact->contact_all($limit,$first, null);
	...
	public function recyclebin()
	{
		...
		$this->data['strphantrang']=$this->phantrang->PagePer($total, $current, $limit, $url='admin/contact/recyclebin', null);
