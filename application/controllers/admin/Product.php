...
class Product extends CI_Controller {
	...
	public function index(){
		...
		$first=$this->phantrang->PageFirst($limit, $current, $keyword);
		$total=$this->Mproduct->product_sanpham_count($keyword);
		$this->data['strphantrang']=$this->phantrang->PagePer($total, $current, $limit, $url='admin/product', $keyword);
		$this->data['list']=$this->Mproduct->product_sanpham($limit,$first, $keyword);
    ...
    if($user_role['role']==2){
      redirect('admin/E403/index','refresh');
         ...
         public function recyclebin(){
           ...
           $this->data['strphantrang']=$this->phantrang->PagePer($total, $current, $limit, $url='./admin/product/recyclebin', null);
        ...
        function is_product_exists($key)
        {
            $this->Mproduct->is_product_exist($key);
        }
