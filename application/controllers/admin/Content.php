...
class Content extends CI_Controller {
	...
	public function index()
	{
		...
		$total=$this->Mcontent->content_count($keyword);
		$this->data['strphantrang']=$this->phantrang->PagePer($total, $current, $limit, $url='admin/content', $keyword);
		$this->data['list']=$this->Mcontent->content_all($limit,$first, $keyword);
	...
	public function recyclebin()
	{
		...
		$this->data['strphantrang']=$this->phantrang->PagePer($total, $current, $limit, $url='admin/content/recyclebin', null);
