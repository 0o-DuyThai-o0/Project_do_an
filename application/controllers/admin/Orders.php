...
class Orders extends CI_Controller {
  ...
  public function index()
  {
    ...
    $total=$this->Morders->orders_count(null);
    $this->data['strphantrang']=$this->phantrang->PagePer($total, $current, $limit, $url='admin/orders', null);
    $this->data['list']=$this->Morders->orders_listorders($limit,$first, null);
  ...
  public function recyclebin()
  {
    ...
    $this->data['strphantrang']=$this->phantrang->PagePer($total, $current, $limit, $url='admin/orders/recyclebin', null);
