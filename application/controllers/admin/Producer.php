...
class Producer extends CI_Controller {
	...
	public function index(){
		...
		$total=$this->Mproducer->producer_count($keyword);
		$this->data['strphantrang']=$this->phantrang->PagePer($total, $current, $limit, $url='admin/producer', $keyword);
		$this->data['list']=$this->Mproducer->producer_all($limit,$first,$keyword);
	...
	public function recyclebin(){
		...
		$this->data['strphantrang']=$this->phantrang->PagePer($total, $current, $limit, $url='admin/producernt/recyclebin', null);
