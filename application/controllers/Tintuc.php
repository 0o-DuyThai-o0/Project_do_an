...
class Tintuc extends CI_Controller {
	...
	public function index(){
		...
		$total=$this->Mcontent->content_count(null);
		$this->data['strphantrang']=$this->phantrang->PagePer($total, $current, $limit, $url='tin-tuc', null);
        $this->data['list']=$this->Mcontent->content_list_home($limit,$first);
        $this->data['title']='Kim Cương - Tin tức';  
