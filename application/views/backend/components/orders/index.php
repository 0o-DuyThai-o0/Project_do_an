												...
												<tr>
													...
													<td style="text-align: center;">
														...
														switch ($val['status']) {
															...
															break;
                                                            case '5':
                                                            echo 'Đã thanh toán, đang giao hàng';
                                                            break;
														}
														?>
													</td>
													<td style="text-align: center;">
                                                        ...
                                                        <a class="btn btn-default btn-xs" href="<?php echo base_url() ?>admin/orders/status/<?php echo $val['id'] ?>"  onclick="return confirm('Xác nhận đơn hàng đã giao ?')" role = "button">
                                                            <i class="fa fa-check-square-o"></i> Xác nhận đã giao hàng
                                                        </a>
                                                        <?php endif; ?>
														<td>
