    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="box box-info">
          ...
          {   
            $list_orrders = $this->Morders->order_follow_month($year, $i);
            $best_seller = $this->Morders->best_seller_month($year,$i);
            $worst_seller = $this->Morders->worst_seller_month($year,$i);
            $total_month = 0;
            ...
            echo '<div class="col-sm-4 col-xs-6" style="border: 1px solid #ccc;min-height: 180px">
                ...
                <div class="description-block border-right" style="text-align: left">
    
                  <span class="description-text">Mặt hàng bán chạy nhất tháng '.$i.' : </span>
                  <h5 class="description-header" style="color: #e90000;">'.$best_seller.'</h5>
                </div>
                <div class="description-block border-right" style="text-align: left">
                                  
                  <span class="description-text">Mặt hàng ít lượt mua nhất tháng '.$i.' : </span>
                  <h5 class="description-header" style="color: #e90000;">'.$worst_seller.'</h5>
                </div>
                <!-- /.description-block -->
              </div>';
          }
