<div class="content-wrapper">
	<section class="content-header">
		...
		<div class="breadcrumb">
			...
			?>
			<a class="btn btn-primary btn-sm" href="admin/producer/recyclebin" role="button">
					...
					<div class="box-header with-border">
						...
						<div class="box-body">
							...
							<div id="example1_filter" class="dataTables_filter">
								<form>
								<input type="text" name="query" placeholder="Nhập tên nhà cung cấp"/>
											...
											<?php foreach ($list as $row):?>
												<tr>
													...
													<td class="text-center">
														...
														<td class="text-center">
															<a class="btn btn-danger btn-xs" href="admin/producer/trash/<?php echo $row['id'] ?>" onclick="return confirm('Xác nhận xóa Nhà cung cấp này ?')" role = "button">
