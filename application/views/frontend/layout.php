    ...
    <title>
        <?php 
            if(isset($title))
                ...
                echo "Kim Cương - trang sức uy tín, chính hãng";
        ?>
    </title>
...
<script src="https://code.jquery.com/jquery-2.2.4.min.js" integrity="sha256-BbhdlvQf/xTY9gja0Dq3HiwQF8LaCRTXxZKRutelT44=" crossorigin="anonymous"></script>
        ...
        <script src="public/js/owl.navigation.js"></script>
        <script src="public/js/owl.animate.js"></script>
        <script src="public/js/owl.autoheight.js"></script>
        <script src="public/js/owl.autoplay.js"></script>
        <script src="public/js/owl.support.js"></script>
