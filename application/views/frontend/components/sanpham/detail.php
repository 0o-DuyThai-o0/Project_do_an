					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
						<div class="product-view-content">
								...
								<div id="km-detail">
									...
									<div class="fk-main">
										<div class="fk-sales">
											...
											<ul>
												<li>Tặng bảo hành đổi trả 3 tháng <a href="#" target="_blank">Xem chi tiết</a>
												</li>
											</ul>
											<ul>
												<li>Giảm thêm 10% khi mua 2 sản phẩm <a href="#" target="_blank">Xem chi tiết</a>
												</li>
											</ul>
										</div>
									</div>
							...
							<div style="margin-top: 20px;">
								<b>Kiểm định</b>
								<br>
								<span>Hàng được kiểm định bởi các chuyên gia</span><a href="#" style="color:red"> (Chi tiết)</a>
							</div>
						</div>
					</div>
