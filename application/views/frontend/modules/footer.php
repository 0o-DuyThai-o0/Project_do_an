        ...
        <div class="col-xs-12 col-sm-12 col-md-6">
            <div class="col-xs-12 col-sm-6">
                ...
                <div class="about-store">
                      Sản phẩm chất lượng - giá cả hợp lý với mọi nhà
             </div>
         </div>
         <div class="col-xs-12 col-sm-6">
            <div class="f-contact">
                ...
                <ul class="list-unstyled">
                    <li class="clearfix">
                        ...
                        <span>Số 298 Đường Cầu Diễn, Minh Khai, Bắc Từ Liêm, Hà Nội, Việt Nam</span>
                    </li>
                    <li class="clearfix">
                    ...
                    <li class="clearfix">
                        ...
                        <span><a href="mailto:ngochao10121999@gmail.com">kimcuong@gmail.com</a></span>
                    </li>
                </ul>
            </div>
        </div>
