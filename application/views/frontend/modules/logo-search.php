    ...
    <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 search">
      <div class="contact-row">
        <div class="phone inline">
          <i class="icon fa fa-phone"></i> (84) 888 888 888
        </div>
        <div class="contact inline">
          <i class="icon fa fa-envelope"></i> kimcuong@gmail.com
        </div>
      </div>
      <form action="search" method="get" role="form">
        <div class="input-search">
          <input type="text" class="form-control" id="search_text" name="search" placeholder="Nhập tên sản phẩm">
          <button>
      ...
      <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 hidden-xs" style="padding: 12px;">
       <!-- Cart -->
